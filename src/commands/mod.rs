...
pub use device::{
    cmd_device_add, cmd_device_evacuate, cmd_device_offline, cmd_device_online, cmd_device_remove,
...
pub use key::{cmd_remove_passphrase, cmd_set_passphrase, cmd_unlock};
...
pub fn build_cli() -> Command {
    ...
    cmd = cmd
        ...
        .subcommand(Command::new("version").about("Display version"));
    ...
    cmd = cmd
        .subcommand(
            Command::new("data")
                .about("Manage filesystem data")
                .subcommand(scrub::Cli::command().name("scrub")),
        )
        .subcommand(
            Command::new("device")
                .about("Manage devices within a filesystem")
        ...
        .subcommand(
            Command::new("fs")
                .about("Manage a running filesystem")
        ...
        .subcommand(
            Command::new("image")
                .about("Filesystem image commands")
        ...
        .subcommand(
            Command::new("reconcile")
                .about("Reconcile filesystem data")
